...
export default function InventoryCard({volume, title, num, icon, dateBestBefore, dateScanned, brand, allergens}) {
        ...
        <div className="inventoryDialog__titleBox">
          ...
          <button onClick={closeDialog}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M8.03027 8.46973L15.5303 15.9697" stroke="black" stroke-linecap="round"/>
              <path d="M15.5303 8.46973L8.03027 15.9697" stroke="black" stroke-linecap="round"/>
            </svg>
          </button>
        </div>
        </div>
        ...
        <div className="inventoryDialog__details">
          ...
          <div className="inventoryDialog__details--bestFør">
            <div>
              ...
              <p className='smallp'>Best før: {(dateBestBefore)?formatDate(dateBestBefore):'23.11.23'}</p>
            </div>
            <div>
              <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="6.47795" cy="2.43474" r="1.93474" fill="#1A1A1A" stroke="#1A1A1A"/>
              ...
              <g clip-path="url(#clip0_257_2111)">
                <path d="M11 6.99896C10.9855 8.70596 10.8908 9.647 10.2702 10.2676C9.53776 11 8.35894 11 6.0013 11C3.64367 11 2.46485 11 1.73242 10.2676C1 9.53515 1 8.35633 1 5.9987C1 3.64106 1 2.46224 1.73242 1.72982C2.353 1.10924 3.29403 1.01447 5.00104 1" stroke="#1A1A1A" stroke-linecap="round"/>
                <path d="M11 3.5H7C6.21143 3.5 5.69464 3.8358 5.43898 4.05801C5.32073 4.16079 5.26161 4.21218 5.2369 4.2369C5.21218 4.26161 5.16079 4.32073 5.05801 4.43898C4.8358 4.69464 4.5 5.21143 4.5 6V7.5M11 3.5L8.5 1M11 3.5L8.5 6" stroke="#1A1A1A" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
                <defs>
          ...
          <div className='inventoryDialog__scannedAndDelete'>
            <p className='inventoryDialog__scannedAndDelete--scanned'>Scannet <span className='smallp'>{formatDate(dateScanned)}</span></p>
            <button>Slett varene</button>
          </div>
      </dialog>
    </>
  );
